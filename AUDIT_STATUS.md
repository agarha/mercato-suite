...
| F. Product / Vendor Lifecycle | Partial | Vendor signup, approval/rejection/suspension, KYC, onboarding checklist, dashboard shell. | Staff roles and profile settings depth missing; rejection email delivery still needs template coverage. |
